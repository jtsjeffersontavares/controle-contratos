...
urlpatterns = [
    path(
        "media/<path:path>", views.ProtectedMediaView.as_view(), name="protected_media"
    ),
    ...
    path(
        "pregoes/novo/",
        views.ProcurementCreateView.as_view(),
        name="procurement_create",
    ),
    path(
        "pregoes/<int:pk>/",
        views.ProcurementDetailView.as_view(),
        name="procurement_detail",
    ),
    path(
        "pregoes/<int:pk>/editar/",
        views.ProcurementUpdateView.as_view(),
        name="procurement_update",
    ),
    path(
        "pregoes/<int:pk>/excluir/",
        views.ProcurementDeleteView.as_view(),
        name="procurement_delete",
    ),
    path(
        "pregoes/<int:pk>/resumo/",
        views.ProcurementSummaryView.as_view(),
        name="procurement_summary",
    ),
    path(
        "pregoes/itens/novo/",
        views.ProcurementItemCreateView.as_view(),
        name="procurement_item_create",
    ),
    path(
        "pregoes/itens/<int:pk>/editar/",
        views.ProcurementItemUpdateView.as_view(),
        name="procurement_item_update",
    ),
    path(
        "pregoes/itens/<int:pk>/excluir/",
        views.ProcurementItemDeleteView.as_view(),
        name="procurement_item_delete",
    ),
    path(
        "pregoes/itens/<int:pk>/dados/",
    ...
    path(
        "contratos/<int:pk>/itens-ordem/",
        views.ContractOrderItemsView.as_view(),
        name="contract_order_items",
    ),
    path(
    ...
    path(
        "organizacoes/", views.OrganizationListView.as_view(), name="organization_list"
    ),
    path(
        "organizacoes/nova/",
    ...
    path(
        "empenhos/novo/", views.CommitmentCreateView.as_view(), name="commitment_create"
    ),
    path(
        "empenhos/<int:pk>/editar/",
        views.CommitmentUpdateView.as_view(),
        name="commitment_update",
    ),
    path(
        "empenhos/<int:pk>/excluir/",
        views.CommitmentDeleteView.as_view(),
        name="commitment_delete",
    ),
    path("ordens/", views.SupplyOrderListView.as_view(), name="supplyorder_list"),
    path(
        "ordens/nova/", views.SupplyOrderCreateView.as_view(), name="supplyorder_create"
    ),
    path(
        "ordens/<int:pk>/editar/",
        views.SupplyOrderUpdateView.as_view(),
        name="supplyorder_update",
    ),
    path(
        "ordens/<int:pk>/excluir/",
        views.SupplyOrderDeleteView.as_view(),
        name="supplyorder_delete",
    ),
    ...
    path(
        ...
        views.DeliveryDeleteView.as_view(),
    ...
    path(
        "alteracoes/<int:pk>/editar/",
        views.ChangeUpdateView.as_view(),
        name="change_update",
    ),
    path(
        "alteracoes/<int:pk>/excluir/",
        views.ChangeDeleteView.as_view(),
        name="change_delete",
    ),
    ...
    path(
        "documentos/novo/", views.DocumentCreateView.as_view(), name="document_create"
    ),
    path(
    ...
    path(
        "importar/modelo/",
        views.DownloadImportTemplateView.as_view(),
        name="import_template",
    ),
    path(
        "importar/<int:pk>/previa/",
        views.ImportPreviewView.as_view(),
        name="import_preview",
    ),
    path(
        "importar/<int:pk>/cancelar/",
        views.ImportCancelView.as_view(),
        name="import_cancel",
    ),
    path(
        "relatorios/contratos.csv",
        views.ExportContractsCsvView.as_view(),
        name="export_contracts_csv",
    ),
    path(
        "relatorios/contratos.xlsx",
        views.ExportContractsXlsxView.as_view(),
        name="export_contracts_xlsx",
    ),
    path(
        "relatorios/contratos.pdf",
        views.ExportContractsPdfView.as_view(),
        name="export_contracts_pdf",
    ),
    path(
        "relatorios/pregoes.csv",
        views.ExportProcurementsCsvView.as_view(),
        name="export_procurements_csv",
    ),
    path(
        "relatorios/pregoes.xlsx",
        views.ExportProcurementsXlsxView.as_view(),
        name="export_procurements_xlsx",
    ),
    path(
        "relatorios/pregoes.pdf",
        views.ExportProcurementsPdfView.as_view(),
        name="export_procurements_pdf",
    ),
]
